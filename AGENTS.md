...
- Keep the generated ADK/A2A plumbing in `app/app_utils/` intact unless a task explicitly
  requires changing that integration boundary.
- Update `docs/architecture.md` when package boundaries, entry points, routes, models,
  scheduler behavior, or persistence responsibilities change.
